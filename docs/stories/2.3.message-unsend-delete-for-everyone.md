...
**Test Coverage:**
- [ ] testCanDelete_OwnMessage_Within24Hours_ReturnsTrue
- [ ] testCanDelete_OtherUsersMessage_ReturnsFalse
- [ ] testCanDelete_OwnMessage_After24Hours_ReturnsFalse
- [ ] testCanDelete_AlreadyDeleted_ReturnsFalse
- [ ] testShowDeleteConfirmation_ValidMessage_ShowsAlert
- [ ] testShowDeleteConfirmation_InvalidMessage_ShowsError
- [ ] testConfirmDelete_Success_MarksDeleted
- [ ] testConfirmDelete_OptimisticUI_ShowsPlaceholderImmediately
- [ ] testConfirmDelete_NetworkFailure_RevertsToOriginal
- [ ] testConfirmDelete_UpdatesConversationPreview
...
- [ ] 10 unit tests added (Total: 114 passing)
- [ ] Manual testing checklist complete (63 checkpoints)
- [ ] No regressions in message sending, editing, or group chat
- [ ] Privacy compliance verified (text removed from Firestore)
...
**Modified Files:**
- `MessageAI/Presentation/ViewModels/Chat/ChatViewModel.swift` (added delete methods)
- `MessageAI/Presentation/Views/Chat/ChatView.swift` (added delete confirmation alert)
- `MessageAI/Presentation/Views/Chat/MessageKitWrapper.swift` (added "Unsend" to context menu, deleted message styling)
- `MessageAI/Data/Repositories/FirebaseMessageRepository.swift` (enhanced deleteMessage)
- `MessageAI/Data/Repositories/RepositoryError.swift` (added .unauthorized case, if needed)
- `MessageAITests/Presentation/ViewModels/ChatViewModelTests.swift` (added 10 tests)
- `MessageAITests/Data/Mocks/MockMessageRepository.swift` (added delete tracking)
- `MessageAITests/Data/Mocks/MockConversationRepository.swift` (added update tracking)
- `MessageAITests/Integration/RealTimeMessagingIntegrationTests.swift` (added delete test)
- *(Optional)* `scripts/seed-test-data.js` (added deleted message samples)
